...
public class UserProfileService {
	...
	public UserProfileService() {
		...
		if (userMap == null) {
			...
			User user1 = new User(1, "John", 32, "Male", "20401 N 19th Avenue", "USA", "85027");
			User user2 = new User(2, "Paul", 35, "Male", "20654 N 56th Avenue","USA","85032");
			User user3 = new User(3, "Joe", 32, "Female", "44444 N 19th Avenue","USA","85093");
